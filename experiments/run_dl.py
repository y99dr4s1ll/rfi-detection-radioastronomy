...
if DATASET == 'luserna':
    ...
    train_data = get_patches_batched(train_data, p_size, s_size, rate, padding='VALID')
    train_masks = get_patches_batched(train_masks.astype('float32'), p_size, s_size, rate, padding='VALID')
    test_data_p = get_patches_batched(test_data, p_size, s_size, rate, padding='VALID')
    test_masks_p = get_patches_batched(test_masks.astype('float32'), p_size, s_size, rate, padding='VALID')
